...
public class RestauranteController {
    ...
    public Restaurante atualizar(@PathVariable Long restauranteId,
        ...
        BeanUtils.copyProperties(restaurante, restauranteAtual
                , "id", "formas_pagamento", "endereco", "dataCadastro", "produtos");
        try {
    ...
    private void merge(Map<String, Object> dadosOrigem, Restaurante restauranteDestino, HttpServletRequest httpServletRequest) {
        try {
            ...
            throw new HttpMessageNotReadableException(e.getMessage(), ExceptionUtils.getRootCause(e), servletServerHttpRequest);
        }
    }
