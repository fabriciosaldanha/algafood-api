...
insert into restaurante (id, nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, data_cadastro, data_atualizacao)
    values
        (1, 'Thai Gourmet', 10, 1, 1, '38400-999', 'Rua João Pinheiro', '1000', 'Centro', utc_timestamp, utc_timestamp);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao)
    values
        ...
        (3, 'Tuk Tuk Comida Indiana', 15, 2, utc_timestamp, utc_timestamp),
        (4, 'Java Steakhouse', 12, 3, utc_timestamp, utc_timestamp),
        (5, 'Lanchonete do Tio Sam', 11, 4, utc_timestamp, utc_timestamp),
        (6, 'Bar da Maria', 6, 4, utc_timestamp, utc_timestamp);
